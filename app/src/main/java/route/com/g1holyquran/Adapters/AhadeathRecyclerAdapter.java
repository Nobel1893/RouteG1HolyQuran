...
public class AhadeathRecyclerAdapter extends RecyclerView.Adapter <AhadeathRecyclerAdapter.ViewHolder> {

    ArrayList<HadeathItem> data;
    ...
    public AhadeathRecyclerAdapter(ArrayList data){
        this.data=data;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        HadeathItem item=data.get(position);
